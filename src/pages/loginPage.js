...
function LoginPage({setUserActivated}) {
    ...
    return (<Box sx={{display: "flex", height: "100vh", background: "#EDEFF3"}}>
        <img
            alt=""
        ...
        >
            ...
            <Typography
                sx={{
                    fontFamily: "SFProDisplay, sans-serif", fontSize: "16px", color: "#8D9BA8", width: "330px",
                }}
            >
            ...
            >
                <TextField
                    ...
                    fullWidth
                    sx={{
                        border: "none", height: "50%", color: "#2F2F2F", fontFamily: "SFProDisplay", fontSize: "18px"
                    }}
            ...
            >
                <Typography sx={{color: "#FFF", fontFamily: "SFProDisplay", fontSize: "15px"}}>Tizimga
                    kirish</Typography>
            </Button>
